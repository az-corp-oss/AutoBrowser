...
public class HomeViewModelRuleTests
{
    ...
    private HomeViewModel CreateViewModelWithRules(List<RoutingRule>? initialRules = null)
    {
        var groups = new List<RuleGroup>
        {
            new RuleGroup
            {
                ...
                IsEnabled = true,
                Sequence = 1,
                Rules = new ObservableCollection<RoutingRule>(initialRules ?? [])
            }
        };
        return CreateViewModel(groups);
    }

    [Fact]
    public void AddRule_Directly_AddsToCollection()
    {
        var vm = CreateViewModelWithRules();
    ...
    [Fact]
    public void AddRule_Directly_CallsSaveGroups()
    {
        var vm = CreateViewModelWithRules();
        var rule = new RoutingRule { Name = "GitHub", UrlPattern = "github.com", IsEnabled = true };
        ...
        _mockRuleService.Verify(x => x.SaveGroups(It.IsAny<List<RuleGroup>>()), Times.AtLeastOnce);
    }
    ...
    public void AddRule_MultipleRules_AllSaved()
    {
        ...
        _mockRuleService.Verify(x => x.SaveGroups(It.IsAny<List<RuleGroup>>()), Times.AtLeast(3));
    }

    [Fact]
    public void EditRule_ChangeName_CallsSaveGroups()
    {
        var vm = CreateViewModelWithRules();
        ...
        _mockRuleService.Verify(x => x.SaveGroups(It.IsAny<List<RuleGroup>>()), Times.AtLeast(2));
    }

    [Fact]
    public void EditRule_ChangePattern_CallsSaveGroups()
    {
        var vm = CreateViewModelWithRules();
    ...
    [Fact]
    public void EditRule_ToggleEnabled_CallsSaveGroups()
    {
        var vm = CreateViewModelWithRules();
    ...
    [Fact]
    public void EditRule_ChangeBrowserPath_CallsSaveGroups()
    {
        var vm = CreateViewModelWithRules();
    ...
    [Fact]
    public void EditRule_ChangeSequence_CallsSaveGroups()
    {
        var vm = CreateViewModelWithRules();
    ...
    [Fact]
    public void DeleteRule_Directly_CallsSaveGroups()
    {
        var vm = CreateViewModelWithRules();
        var rule = new RoutingRule { Name = "ToDelete", UrlPattern = "delete.com" };
        vm.Rules.Add(rule);
    ...
    public void MoveUp_MiddleRule_MovesUp()
    {
        ...
        Assert.Equal(1, rule2.Sequence);
        Assert.Equal(2, rule1.Sequence);
        Assert.Equal(3, rule3.Sequence);
    }

    [Fact]
    public void MoveUp_CallsSaveGroups()
    {
        var vm = CreateViewModelWithRules();
    ...
    public void MoveDown_MiddleRule_MovesDown()
    {
        ...
        // Verify sequences are updated
        Assert.Equal(1, rule1.Sequence);
        Assert.Equal(2, rule3.Sequence);
        Assert.Equal(3, rule2.Sequence);
    }

    [Fact]
    public void MoveDown_CallsSaveGroups()
    {
        var vm = CreateViewModelWithRules();
        var rule1 = new RoutingRule { Name = "First", UrlPattern = "a.com" };
        var rule2 = new RoutingRule { Name = "Second", UrlPattern = "b.com" };
    ...
    public void Rules_LoadFromService_AppliedToViewModel()
    {
        ...
        var vm = CreateViewModelWithRules(initialRules);
    ...
    public void Rule_PropertyChange_TriggersSave()
    {
        ...
        _mockRuleService.Verify(x => x.SaveGroups(It.IsAny<List<RuleGroup>>()), Times.Once);
    }
}
