...
public partial class HomeViewModel : ObservableObject
{
        ...
        IEnumerable<IBrowserLauncher> launchers)
    {
        ...
        _defaultBrowserService = defaultBrowserService ?? throw new ArgumentNullException(nameof(defaultBrowserService));
    ...
    {
        var dialog = new RuleTesterView(_settingsService, "Test URL", "Enter URL to test routing:");
        dialog.ShowDialog();
