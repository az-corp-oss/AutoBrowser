...
public partial class App
{
    private async Task CheckAndPromptReRegister()
    {
        ...
        if (needsReRegister)
        {
            ...
            {
                if (registrationType.Contains("protocol", StringComparison.OrdinalIgnoreCase))
                {
                ...
                if (registrationType.Contains("default browser", StringComparison.OrdinalIgnoreCase))
                {
